...
import { getNewSenderFull, getOppositeName, getSenderFull } from '../config/ChatLogics';
import UpdateGroupChatModal from '../miscellaneous/UpdateGroupChatModal';
import { FormControl, Input } from "@chakra-ui/react"
import { allMessagesFunction, sendMessageFunction, updateSeenMessageFunction } from '../../redux/actions/message';
import "./styles.css";
        ...
        const handleMessageReceived = async (newMessageReceived) => {
            if (!selectedChatCompare || selectedChatCompare._id !== newMessageReceived.chat._id) {
                ...
                if (!messageArray.some((msg) => msg._id === newMessageReceived._id)) {
                    ...
                    // await dispatch(fetchMyAllMessagesFunction());
                    dispatch(updateSeenMessageFunction(newMessageReceived._id));
                }
            }
        };
                    ...
                    >
                        ...
                        />
                        {
                            !selectedChat.isGroupChat ? (
                                <>
                                    {
                                        getNewSenderFull(selectedChat, me).name
                                    }
                                </>
                            ) :
                                (<>
